...
set(hypre_url_file     ${PececilloTPL_SOURCE_DIR}/tarfiles/${EP_HYPRE_ARCHIVE_FILE})
set(hypre_prefix_dir   ${PececilloTPL_BINARY_DIR}/hypre)
...
set(hypre_install_dir  ${TPL_INSTALL_PREFIX})
...
configure_file(${PececilloTPL_SOURCE_DIR}/templates/hypre-configure-step.sh.in
               ${hypre_sh_configure}
	       @ONLY)
...
configure_file(${PececilloTPL_SOURCE_DIR}/templates/hypre-build-step.sh.in
               ${hypre_sh_build}
	       @ONLY)
...
configure_file(${PececilloTPL_SOURCE_DIR}/templates/hypre-install-step.sh.in
               ${hypre_sh_install}
	       @ONLY)
