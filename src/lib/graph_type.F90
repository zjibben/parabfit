...
!! finalized when deallocated or otherwise cease to exist.  Only intrinsic aObjects of this type
!! should not be used in assignment statements, as only intrinsic assignemIt has the following type bound
!! procedures.
!!
