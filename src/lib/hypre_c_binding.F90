...
module hypre_c_binding
  ...
  !! Functions from the FlexGMRES interface
  public :: HYPRE_FlexGMRESDestroy
  public :: HYPRE_FlexGMRESSetMaxIter
  public :: HYPRE_FlexGMRESGetNumIterations
  public :: HYPRE_FlexGMRESSetTol
  public :: HYPRE_FlexGMRESSetAbsoluteTol
  public :: HYPRE_FlexGMRESSetKDim
  public :: HYPRE_FlexGMRESGetFinalRelativeResidualNorm
  public :: HYPRE_FlexGMRESSetPrintLevel
  ...
  public :: HYPRE_Ext_FlexGMRESCreate
  public :: HYPRE_Ext_FlexGMRESSetup
  public :: HYPRE_Ext_FlexGMRESSolve
  public :: HYPRE_Ext_FlexGMRESSetBoomerAMGPrecond
 ...
 !!
 !! FlexGMRES INTERFACES
 !!

  interface
    ! See HYPRE_Ext_FlexGMRESCreate below; wraps HYPRE_ParCSRFlexGMRESCreate.
    function HYPRE_FlexGMRESDestroy (solver) &
        result(ierr) bind(c, name="HYPRE_ParCSRFlexGMRESDestroy")
      import c_ptr, c_int
      type(c_ptr), value :: solver
      integer(c_int) :: ierr
    end function
    ! See HYPRE_Ext_FlexGMRESSetup below.
    ! See HYPRE_Ext_FlexGMRESSolve below.
    function HYPRE_FlexGMRESSetMaxIter(solver, max_iter) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESSetMaxIter")
      import c_ptr, c_int
      type(c_ptr), value :: solver
      integer(c_int), value :: max_iter
      integer(c_int) :: ierr
    end function
    function HYPRE_FlexGMRESGetNumIterations(solver, iters) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESGetNumIterations")
      import c_ptr, c_int
      type(c_ptr), value :: solver
      integer(c_int), intent(out) :: iters
      integer(c_int) :: ierr
    end function HYPRE_FlexGMRESGetNumIterations
    function HYPRE_FlexGMRESSetTol(solver, tol) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESSetTol")
      import c_ptr, c_int, c_double
      type(c_ptr), value :: solver
      real(c_double), value :: tol
      integer(c_int) :: ierr
    end function
    function HYPRE_FlexGMRESSetAbsoluteTol(solver, tol) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESSetAbsoluteTol")
      import c_ptr, c_int, c_double
      type(c_ptr), value :: solver
      real(c_double), value :: tol
      integer(c_int) :: ierr
    ...
    function HYPRE_FlexGMRESSetKDim (solver, k_dim) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESSetKDim")
      import c_ptr, c_int
      type(c_ptr), value :: solver
      integer(c_int), value :: k_dim
      integer(c_int) :: ierr
    end function
    function HYPRE_FlexGMRESGetFinalRelativeResidualNorm(solver, tol) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESGetFinalRelativeResidualNorm")
      import c_ptr, c_int, c_double
      type(c_ptr), value :: solver
      real(c_double), intent(out) :: tol
      integer(c_int) :: ierr
    end function
    function HYPRE_FlexGMRESSetPrintLevel(solver, print_level) &
        result(ierr) bind(c, name="HYPRE_FlexGMRESSetPrintLevel")
      import c_ptr, c_int
      type(c_ptr), value :: solver
      integer(c_int), value :: print_level
      integer(c_int) :: ierr
 ...
 !!
  ...
  interface
    ...
    !! FlexGMRES Interfaces
    function HYPRE_Ext_FlexGMRESCreate(solver) &
        result(ierr) bind(c, name="HYPRE_Ext_ParCSRFlexGMRESCreate")
      import c_ptr, c_int
      type(c_ptr), intent(inout) :: solver
      integer(c_int) :: ierr
    end function
    function HYPRE_Ext_FlexGMRESSetup(solver, A, b, x) &
        result(ierr) bind(c, name="HYPRE_Ext_FlexGMRESSetup")
      import c_ptr, c_int
      type(c_ptr), value :: solver, A, b, x
      integer(c_int) :: ierr
    end function
    function HYPRE_Ext_FlexGMRESSolve(solver, A, b, x) &
        result(ierr) bind(c, name="HYPRE_Ext_FlexGMRESSolve")
      import c_ptr, c_int
      type(c_ptr), value :: solver, A, b, x
      integer(c_int) :: ierr
    end function
    function HYPRE_Ext_FlexGMRESSetBoomerAMGPrecond(solver, precond) &
        result(ierr) bind(c, name="HYPRE_Ext_FlexGMRESSetBoomerAMGPrecond")
      import c_ptr, c_int
      type(c_ptr), value :: solver, precond
      integer(c_int) :: ierr
    end function
