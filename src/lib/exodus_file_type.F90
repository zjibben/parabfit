...
!!    happens automatically with the object goes out of scope.
!!
...
!!    for the sides belonging to the specified side set ID.
!!
...
contains
 ...
 !! data components of the object.
  ...
  subroutine exodus_file_open (this, path, stat, errmsg)
    ...
    io_ws = 0   ! let ex_open tell us the file real size
