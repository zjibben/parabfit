...
module fhypre
  ...
  !! FlexGMRES interface procedures
  public :: fHYPRE_FlexGMRESCreate
  public :: fHYPRE_FlexGMRESDestroy
  public :: fHYPRE_FlexGMRESSetup
  public :: fHYPRE_FlexGMRESSolve
  public :: fHYPRE_FlexGMRESSetPrecond
  public :: fHYPRE_FlexGMRESSetMaxIter
  public :: fHYPRE_FlexGMRESGetNumIterations
  public :: fHYPRE_FlexGMRESSetTol
  public :: fHYPRE_FlexGMRESSetAbsoluteTol
  public :: fHYPRE_FlexGMRESSetKDim
  public :: fHYPRE_FlexGMRESGetFinalRelRes
  public :: fHYPRE_FlexGMRESSetPrintLevel
...
contains
  ...
  subroutine fHYPRE_FlexGMRESCreate (solver, ierr)
    type(c_ptr), intent(inout) :: solver
    integer, intent(out) :: ierr
    ierr = HYPRE_Ext_FlexGMRESCreate(solver)
  end subroutine

  subroutine fHYPRE_FlexGMRESDestroy (solver, ierr)
    type(c_ptr), intent(inout) :: solver
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESDestroy(solver)
    solver = c_null_ptr
  end subroutine

  subroutine fHYPRE_FlexGMRESSetup (solver, A, b, x, ierr)
    type(c_ptr), intent(in) :: solver, A, b, x
    integer, intent(out) :: ierr
    ierr = HYPRE_Ext_FlexGMRESSetup(solver, A, b, x)
  end subroutine

  subroutine fHYPRE_FlexGMRESSolve (solver, A, b, x, ierr)
    type(c_ptr), intent(in) :: solver, A, b, x
    integer, intent(out) :: ierr
    ierr = HYPRE_Ext_FlexGMRESSolve(solver, A, b, x)
  end subroutine

  subroutine fHYPRE_FlexGMRESSetPrecond (solver, precond, ierr)
    type(c_ptr), intent(in) :: solver, precond
    integer, intent(out) :: ierr
    ierr = HYPRE_Ext_FlexGMRESSetBoomerAMGPrecond(solver, precond)
  end subroutine fHYPRE_FlexGMRESSetPrecond

  subroutine fHYPRE_FlexGMRESSetMaxIter (solver, max_iter, ierr)
    type(c_ptr), intent(in) :: solver
    integer, intent(in) :: max_iter
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESSetMaxIter(solver, max_iter)
  end subroutine

  subroutine fHYPRE_FlexGMRESGetNumIterations (solver, iters, ierr)
    type(c_ptr), intent(in) :: solver
    integer, intent(out) :: iters, ierr
    ierr = HYPRE_FlexGMRESGetNumIterations(solver, iters)
  end subroutine fHYPRE_FlexGMRESGetNumIterations

  subroutine fHYPRE_FlexGMRESSetTol (solver, tol, ierr)
    type(c_ptr), intent(in) :: solver
    real(r8), intent(in) :: tol
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESSetTol(solver, tol)
  end subroutine

  subroutine fHYPRE_FlexGMRESSetAbsoluteTol (solver, tol, ierr)
    type(c_ptr), intent(in) :: solver
    real(r8), intent(in) :: tol
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESSetAbsoluteTol(solver, tol)
  end subroutine

  subroutine fHYPRE_FlexGMRESSetKDim (solver, k_dim, ierr)
    type(c_ptr), intent(in) :: solver
    integer, intent(in) :: k_dim
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESSetKDim (solver, k_dim)
  end subroutine

  subroutine fHYPRE_FlexGMRESGetFinalRelRes (solver, tol, ierr)
    type(c_ptr), intent(in) :: solver
    real(r8), intent(out) :: tol
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESGetFinalRelativeResidualNorm(solver, tol)
  end subroutine

  subroutine fHYPRE_FlexGMRESSetPrintLevel (solver, print_level, ierr)
    type(c_ptr), intent(in) :: solver
    integer, intent(in) :: print_level
    integer, intent(out) :: ierr
    ierr = HYPRE_FlexGMRESSetPrintLevel(solver, print_level)
  end subroutine
