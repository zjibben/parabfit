program unit_test
  ...
  ! call material_flux_unit_test (locate_plane, 0.5_r8*posXflow, 7.0_r8/48.0_r8)

  ! ! cube half filled along xy diagonal
  ! write(*,*)
  ! call locate_plane%unit_test (posxyn, 0.5_r8, 1.0_r8/sqrt(2.0_r8))
  ! call material_flux_unit_test (locate_plane, 0.5_r8*posXflow, 0.125_r8)
  
  ! ! cube one eighth filled along xy diagonal
  ! write(*,*)
  ! call locate_plane%unit_test (-posxyn, 0.125_r8, 1.0_r8/(2.0_r8*sqrt(2.0_r8)))
